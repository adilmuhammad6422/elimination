...
public:
	...
	MaterialHandle_t FirstMaterial()
	{
		...
		return CallVFunction< OriginalFn >(this, 86)(this);
	}
	MaterialHandle_t NextMaterial(MaterialHandle_t h)
	{
		VirtualFn(MaterialHandle_t)(PVOID, MaterialHandle_t);
		return CallVFunction< OriginalFn >(this, 87)(this, h);
	}
	MaterialHandle_t InvalidMaterial()
	{
		VirtualFn(MaterialHandle_t)(PVOID);
		return CallVFunction< OriginalFn >(this, 88)(this);
	}
	IMaterial* GetMaterial(MaterialHandle_t h)
	{
		VirtualFn(IMaterial*)(PVOID, MaterialHandle_t);
		return CallVFunction< OriginalFn >(this, 89)(this, h);
	}
	int	GetNumMaterials()
	{
		VirtualFn(int)(PVOID);
		return CallVFunction< OriginalFn >(this, 90)(this);
	}
};

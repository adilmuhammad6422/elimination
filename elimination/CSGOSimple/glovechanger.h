//#pragma once
//#include "valve_sdk\misc\ClientClass.hpp"
//#include "options.hpp"
//#include <algorithm>
...
//void GloveChanger()
//{
//	C_BaseEntity *local = (C_BasePlayer*)g_EntityList->GetClientEntity(g_EngineClient->GetLocalPlayer());
//	player_info_t localPlayerInfo;
//	if (!g_EngineClient->GetPlayerInfo(g_EngineClient->GetLocalPlayer(), &localPlayerInfo)) return;
//	DWORD* hMyWearables = (DWORD*)((size_t)local + 0x2EF4);
//	static DWORD glove_handle = 0;
//
//	auto glove = reinterpret_cast<Gloves_t*>(g_EntityList->GetClientEntityFromHandle(hMyWearables[0]));
//
//	if (!glove) // There is no glove
//	{
//		// Try to get our last created glove
//		auto our_glove = reinterpret_cast<Gloves_t*>(g_EntityList->GetClientEntityFromHandle(glove_handle));
//
//		if (our_glove) // Our glove still exists
//		{
//			hMyWearables[0] = glove_handle;
//			glove = our_glove;
//		}
//	}
//

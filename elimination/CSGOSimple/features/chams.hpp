...
private:
    void OverrideMaterial(bool ignoreZ, bool flat, bool wireframe, bool glass, const Color& rgba, bool glow, bool vapor);

	// ya
	IMaterial* materialGlow = nullptr;
	IMaterial* materialVapor = nullptr;
	IMaterial* materialGlowIgnoreZ = nullptr;
	IMaterial* materialVaporIgnoreZ = nullptr;
